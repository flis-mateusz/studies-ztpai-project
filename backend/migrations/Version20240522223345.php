 ...
 */
final class Version20240522223345 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE announcement_upload (id INT AUTO_INCREMENT NOT NULL, media_object_id INT NOT NULL, announcement_id INT NOT NULL, UNIQUE INDEX UNIQ_F68504464DE5A5 (media_object_id), INDEX IDX_F685044913AEA17 (announcement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE announcement_upload ADD CONSTRAINT FK_F68504464DE5A5 FOREIGN KEY (media_object_id) REFERENCES media_object (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE announcement_upload ADD CONSTRAINT FK_F685044913AEA17 FOREIGN KEY (announcement_id) REFERENCES announcement (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MySQL80Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MySQL80Platform'."
        );
        ...
        $this->addSql('CREATE TABLE announcement_like (id INT AUTO_INCREMENT NOT NULL, given_at DATETIME NOT NULL, user_id INT NOT NULL, announcement_id INT NOT NULL, INDEX IDX_805248EFA76ED395 (user_id), UNIQUE INDEX UNIQ_805248EFA76ED395913AEA17 (user_id, announcement_id), INDEX IDX_805248EF913AEA17 (announcement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE announcement_report (id INT AUTO_INCREMENT NOT NULL, given_at DATETIME NOT NULL, is_accepted TINYINT(1) DEFAULT NULL, details LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_0900_ai_ci`, user_id INT NOT NULL, announcement_id INT NOT NULL, UNIQUE INDEX UNIQ_DCFAC1DFA76ED395913AEA17 (user_id, announcement_id), INDEX IDX_DCFAC1DFA76ED395 (user_id), INDEX IDX_DCFAC1DF913AEA17 (announcement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci` ENGINE = InnoDB COMMENT = \'\' ');
