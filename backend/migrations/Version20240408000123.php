 ...
 */
final class Version20240408000123 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE animal_feature (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE announcement (id INT AUTO_INCREMENT NOT NULL, animal_type_id INT NOT NULL, user_id INT NOT NULL, announcement_detail_id INT NOT NULL, deletion_detail_id INT DEFAULT NULL, is_accepted TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_4DB9D91C4A93E3A9 (animal_type_id), INDEX IDX_4DB9D91CA76ED395 (user_id), UNIQUE INDEX UNIQ_4DB9D91CFC1FED97 (announcement_detail_id), UNIQUE INDEX UNIQ_4DB9D91CB7EEA6C1 (deletion_detail_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE announcement_animal_feature (id INT AUTO_INCREMENT NOT NULL, feature_id INT NOT NULL, announcement_id INT NOT NULL, is_positive TINYINT(1) DEFAULT NULL, INDEX IDX_C982DE8960E4B879 (feature_id), INDEX IDX_C982DE89913AEA17 (announcement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE announcement_deletion_detail (id INT AUTO_INCREMENT NOT NULL, deleted_by_id INT NOT NULL, reason VARCHAR(255) NOT NULL, deleted_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_AA5CA358C76F1F52 (deleted_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE announcement_detail (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, locality VARCHAR(255) NOT NULL, price INT DEFAULT NULL, description LONGTEXT NOT NULL, age INT DEFAULT NULL, gender VARCHAR(255) NOT NULL, avatar_url VARCHAR(255) NOT NULL, kind VARCHAR(255) DEFAULT NULL, age_type VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE announcement_like (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, announcement_id INT NOT NULL, given_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_805248EFA76ED395 (user_id), INDEX IDX_805248EF913AEA17 (announcement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE announcement_report (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, announcement_id INT NOT NULL, given_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', is_accepted TINYINT(1) DEFAULT NULL, details LONGTEXT DEFAULT NULL, INDEX IDX_DCFAC1DFA76ED395 (user_id), INDEX IDX_DCFAC1DF913AEA17 (announcement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, phone VARCHAR(15) NOT NULL, name VARCHAR(255) NOT NULL, surname VARCHAR(255) NOT NULL, avatar_url VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
